  ...
  return (
    <footer className=" grid gap-8 md:gap-0 text-gray-500 md:w-4/5 mx-auto mt-32 md:grid-cols-5">
      <div>
        ...
        <p>
          <a href="#">Agreement</a>. <a href="#">Privacy</a>
        </p>
      </div>
      {[1, 2, 3].map((item) => (
        <nav key={item} className=" grid gap-2">
          <p className=" text-lg text-black">Product introduction</p>
      ...
      <nav className=" grid gap-2 content-start">
        <p className=" text-base text-black">Sign Up</p>
        <p>Sign Up Sign Up Sign Up Sign Up Sign Up Sign Up </p>
        <input
          type="text"
          name=""
          id=""
